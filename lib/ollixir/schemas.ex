defmodule Ollixir.Schemas do
  ...
  @doc """
  Fetches a schema from the compiled Ollixir module at runtime.
  ...
  def schema(key) do
    Ollixir.__schemas__() |> Keyword.fetch!(key)
  end
end

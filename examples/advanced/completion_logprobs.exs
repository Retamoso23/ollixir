# Completion Logprobs Example
# Run with: elixir examples/advanced/completion_logprobs.exs
...
IO.puts("Completion response: #{response["response"]}")
print_logprobs.(Map.get(response, "logprobs", []), "completion logprobs")
